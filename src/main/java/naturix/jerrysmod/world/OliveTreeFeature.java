...
import naturix.jerrysmod.utils.IBlockPosQuery;
...
public class OliveTreeFeature extends TreeFeatureBase
{
    public static class Builder extends InnerBuilder<Builder, OliveTreeFeature>
    {
        @Override
        public OliveTreeFeature create()
        {
            return new OliveTreeFeature(this.updateNeighbours, this.placeOn, this.replace, this.log, this.leaves, this.altLeaves, this.vine, this.hanging, this.trunkFruit, this.minHeight, this.maxHeight, this.leafLayers, this.leavesOffset, this.maxLeavesRadius, this.leavesLayerHeight, this.placeVinesOn, this.hangingChance);
        }
    }
    ...
    protected OliveTreeFeature(boolean notify, IBlockPosQuery placeOn, IBlockPosQuery replace, BlockState log,
