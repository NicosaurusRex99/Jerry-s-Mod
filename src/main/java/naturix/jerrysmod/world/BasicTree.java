...
public class BasicTree extends AbstractTreeFeature<NoFeatureConfig> {
    private static final BlockState DEFAULT_TRUNK = ModBlocks.slime_log.getDefaultState();
    private static final BlockState DEFAULT_LEAF = ModBlocks.slime_leaves.getDefaultState();
    protected final int minTreeHeight;
    private final boolean vinesGrow;
    private final BlockState field_76532_c;
    private final BlockState field_76530_d;

    public BasicTree(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51421_1_, boolean p_i51421_2_) {
        this(p_i51421_1_, p_i51421_2_, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public BasicTree(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51422_1_, boolean p_i51422_2_, int p_i51422_3_, BlockState p_i51422_4_, BlockState p_i51422_5_, boolean p_i51422_6_) {
