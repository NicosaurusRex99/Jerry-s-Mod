...
public class LeavesBase extends Block implements net.minecraftforge.common.IShearable{
    ...
    public LeavesBase(String name){
        super(Block.Properties
                ...
                .hardnessAndResistance(0.4f, 1.0f));
    ...
    public void randomTick(BlockState state, World worldIn, BlockPos pos, Random random) {
        if (worldIn.getBlockState(pos.down()) == ModBlocks.slime_log.getDefaultState()&&worldIn.getBlockState(pos.up()) == ModBlocks.slime_log.getDefaultState()&&worldIn.getBlockState(pos.east()) == ModBlocks.slime_log.getDefaultState()&&worldIn.getBlockState(pos.west()) == ModBlocks.slime_log.getDefaultState()&&worldIn.getBlockState(pos.north()) == ModBlocks.slime_log.getDefaultState()&&worldIn.getBlockState(pos.south()) == ModBlocks.slime_log.getDefaultState()) {
