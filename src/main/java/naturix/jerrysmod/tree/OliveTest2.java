...
public class OliveTest2 extends WorldGenAbstractTree {
		...
		public OliveTest2() {
			super(false);
			this.minTreeHeight = Config.TreeHeight;
			this.metaWood = 0;
			this.metaLeaves = 0;
				...
				if (!var7) {
					...
					if ((var8s == Blocks.GRASS || var8s == Blocks.DIRT || var8s == ModBlocks.slimegrass) && par4 < 256 - var6 - 1) {
							...
							for (var14 = par3 - var13; var14 <= par3 + var13; ++var14) {
								...
								for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16) {
									...
									if ((Math.abs(var15) != var13 || Math.abs(var17) != var13 || par2Random.nextInt(2) != 0 && var12 != 0)) {
										par1World.setBlockState(new BlockPos(var14, var11, var16), ModBlocks.oliveleaves.getDefaultState(), 3);
									}
								}
							}
						}
						...
						for (var11 = 0; var11 < var6; ++var11) {
							...
							if (var12 == 0 || var12s == ModBlocks.oliveplanks) {
								par1World.setBlockState(new BlockPos(par3, par4 + var11, par5), ModBlocks.olivelog.getDefaultState(), 3);
