...
{
    public static final PropertyEnum<OliveLog.EnumAxis> LOG_AXIS = PropertyEnum.<OliveLog.EnumAxis>create("axis", OliveLog.EnumAxis.class);
    ...
    public static enum EnumAxis implements IStringSerializable
    {
        ...
        public static OliveLog.EnumAxis fromFacingAxis(EnumFacing.Axis axis)
        {
            switch (axis)
            {
                case X:
